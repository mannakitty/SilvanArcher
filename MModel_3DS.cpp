...
// by: Matthew Fairfax
//
// MModel_3DS.cpp: implementation of the MModel_3DS class.
...
// 3) The texture must be supported by the MGLTexture class
...
#define MAIN3DS				0x4D4D
 ...
 #define EDIT3DS			0x3D3D
  ...
  #define MATERIAL			0xAFFF
   ...
   #define RENDER_TYPE		0xcowModel00
...
void MModel_3DS::Load(char *name)
{
...
void MModel_3DS::CalculateNormals()
{
...
void MModel_3DS::MainChunkProcessor(long length, long findex)
{
	ChunkHeader h;
...
void MModel_3DS::EditChunkProcessor(long length, long findex)
{
	ChunkHeader h;
...
void MModel_3DS::MaterialChunkProcessor(long length, long findex, int matindex)
{
	ChunkHeader h;
...
void MModel_3DS::MaterialNameChunkProcessor(long length, long findex, int matindex)
{
	// move the file pointer to the beginning of the main
	// chunk's data findex + the size of the header
	fseek(bin3ds, findex, SEEK_SET);
...
void MModel_3DS::DiffuseColorChunkProcessor(long length, long findex, int matindex)
{
	ChunkHeader h;
...
void MModel_3DS::FloatColorChunkProcessor(long length, long findex, int matindex)
{
	float r;
	float g;
	float b;
...
void MModel_3DS::IntColorChunkProcessor(long length, long findex, int matindex)
{
	unsigned char r;
	unsigned char g;
	unsigned char b;
...
void MModel_3DS::TextureMapChunkProcessor(long length, long findex, int matindex)
{
	ChunkHeader h;
...
void MModel_3DS::MapNameChunkProcessor(long length, long findex, int matindex)
{
	char name[80];
...
void MModel_3DS::ObjectChunkProcessor(long length, long findex, int objindex)
{
	ChunkHeader h;
...
void MModel_3DS::TriangularMeshChunkProcessor(long length, long findex, int objindex)
{
	ChunkHeader h;
...
void MModel_3DS::VertexListChunkProcessor(long length, long findex, int objindex)
{
...
void MModel_3DS::TexCoordsChunkProcessor(long length, long findex, int objindex)
{
...
void MModel_3DS::FacesDescriptionChunkProcessor(long length, long findex, int objindex)
{
	ChunkHeader h;
...
void MModel_3DS::FacesMaterialsListChunkProcessor(long length, long findex, int objindex, int subfacesindex)
{
