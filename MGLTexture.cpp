...
// by: Matthew Fairfax
//
// MGLTexture.cpp: implementation of the MGLTexture class.
...
void MGLTexture::LoadFromResource(char *name)
{
	// make the texture name all lower case
	texturename = _strlwr(_strdup(name));
...
void MGLTexture::LoadBMP(char *name)
{
...
void MGLTexture::LoadTGA(char *name)
{
...
void MGLTexture::LoadBMPResource(char *name)
{
...
void MGLTexture::LoadTGAResource(char *name)
{
...
void MGLTexture::BuildColorTexture(unsigned char r, unsigned char g, unsigned char b)
{
