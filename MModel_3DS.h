...
// by: Matthew Fairfax
//
// MModel_3DS.h: interface for the MModel_3DS class.
...
// I decided to use my MGLTexture class b/c adding all of its functions
...
glVertex<234><sifd>(type ...)
glVertex<234><sifd>v(type *)
*/
...
public:
	...
	struct Material {
		...
		MGLTexture tex;	// The texture (this is the only outside reference in this class)
	...
	MModel_3DS();			// Constructor
	virtual ~MModel_3DS();	// Destructor
